sap.ui.define([
    ...
    'co/h2a/sigpro/ui/model/formatter'
  ], function(MessageBox, ValueState, Filter, FilterOperator, DateRange, BaseController, JSONModel, formatter) {
    'use strict';
  
    return BaseController.extend('co.h2a.sigpro.ui.controller.InvoiceList', {
      formatter: formatter,
